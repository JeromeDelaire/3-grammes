...
import com.example.jerome.a3grammes.Games.MoreOrLess.MoreOrLess;
...
public class MoreOrLessSettings extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_or_less_settings);
    ...
    private void runGame(View view) {
        ...
        Intent myIntent = new Intent(view.getContext(), MoreOrLess.class);
