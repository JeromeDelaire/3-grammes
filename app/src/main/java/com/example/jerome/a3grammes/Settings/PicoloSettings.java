 ...
 * Paramètres pour le Picolo (Permet de choisir les joueurs)
 **/
...
public class PicoloSettings extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dumb = (CheckBox) findViewById(R.id.dumb_cat);
        hard = (CheckBox) findViewById(R.id.hard_cat);
    ...
    private void runGame(View view) {
        ...
        Intent myIntent = new Intent(view.getContext(), Picolo.class);
        myIntent.putParcelableArrayListExtra("players", players);
        myIntent.putExtra("dumb", dumb.isChecked());
        myIntent.putExtra("sexy", sexy.isChecked());
        myIntent.putExtra("hard", hard.isChecked());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_rules:
                // Règles du Picolo
                Intent myIntent = new Intent(this.getApplicationContext(), PicoloRules.class);
                startActivityForResult(myIntent, 0);
                return true;
